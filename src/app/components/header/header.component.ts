    ...
    <header class="fixed top-0 w-full z-50 transition-all duration-300 glass border-b-0 border-white/5">
      <div class="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <a href="#" class="flex items-center gap-2 group">
          <img [src]="theme.isDark() ? 'assets/icons/sheplabs_logo_white.svg' : 'assets/icons/sheplabs_logo_black.svg'" alt="Shepsoft Labs Logo" class="hidden md:block w-8 h-8 object-contain group-hover:scale-110 transition-transform duration-300">
          <span class="font-montserrat font-bold text-xl tracking-tight dark:text-white">Shepsoft Labs</span>
        </a>
