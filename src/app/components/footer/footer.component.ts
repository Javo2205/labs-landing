      ...
      <div class="container mx-auto px-6 max-w-6xl">
        <div class="flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <div class="flex gap-8">
            <a href="#" class="w-12 h-12 rounded-xl bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center hover:bg-brand-light/10 hover:text-brand-light transition-all">
